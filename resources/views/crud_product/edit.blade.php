            ...
            <form action="{{ route('produk.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12 d-flex flex-row justify-content-between my-4">
                    ...
                    <input type="text" id="name" name="nama"
                        ...
                        placeholder="*masukan nama produk yang diinginkan"
                ...
                <div class="col-12 d-flex flex-row justify-content-between my-4">
                    ...
                    <select name="kategori_id" id="nama-kategori"
                        ...
                        <option value="{{ $item->id }}" {{ old('kategori_id')==$item->id || $product->kategori_id ==
                            $item->id ? 'selected' : '' }}>{{
                            $item->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div class="col-12 d-flex flex-row justify-content-between my-4">
                    ...
                    <input type="text" value="{{ old('harga') ? old('harga') : $product->harga }}" name="harga"
                ...
                <div class="col-12 d-flex flex-row justify-content-between my-4">
                    ...
                    <input type="text" name="stok" value="{{ old('stok') ? old('stok') : $product->stok }}"
                ...
                <div class="col-12 d-flex flex-row justify-content-between my-4">
                    ...
                    <div class="col-9">
                        <img id="preview-image" src="{{ asset('storage/product/'. $product->gambar) }}"
                            class="input-img" alt="">
